...
const Header = () => {
    ...
    const mobileMenuExpand = () => {
        ...
        TweenMax.to(menuButtonItem, .4, { display: 'flex', opacity: 1, y: 0, ease: Power3.easeIn });
    ...
    const mobileMenuShirk = () => {
        ...
        TweenMax.to(menuButtonItem, .4, { display: 'none' ,opacity: 0, y: -150, ease: Power3.easeOut });
